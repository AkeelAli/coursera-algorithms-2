...
highest_ratio_question3 = 0
highest_ratio_question4 = 0
for i in range(RUNS):
    jobs = []
    ...
    if question3_ratio > highest_ratio_question3:
    	highest_ratio_question3 = question3_ratio
	
    if question4_ratio > highest_ratio_question4:
        highest_ratio_question4 = question4_ratio
    
print "Question 3 c >= " + str(highest_ratio_question3)
print "Question 4 c >= " + str(highest_ratio_question4)
